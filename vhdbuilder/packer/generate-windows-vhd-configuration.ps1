...
# Generate cache map according to Windows SKU
...
$global:map = @{
    "c:\akse-cache\"              = $akseCache
    "c:\akse-cache\calico\"       = $akseCacheCalico
    "c:\akse-cache\containerd\"   = $akseCacheContainerd
    "c:\akse-cache\csi-proxy\"    = $akseCacheCsiProxy
    "c:\akse-cache\win-k8s\"      = $akseCacheWinK8s
    "c:\akse-cache\win-vnet-cni\" = $akseCacheWinVnetCni
}
'@
