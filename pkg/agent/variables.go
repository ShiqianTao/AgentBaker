...
func getWindowsCustomDataVariables(config *datamodel.NodeBootstrappingConfiguration) paramsMap {
	...
	customData := map[string]interface{}{
		...
		"isNotRebootWindowsNode":               strconv.FormatBool(config.AgentPoolProfile.WindowsProperties.IsNotRebootNode()),
		"isDisableWindowsOutboundNat":          strconv.FormatBool(config.AgentPoolProfile.WindowsProperties.IsDisableOutboundNat()),
	}
